 ...
 */
public class Rev2Adapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        tvd.title.setText(list.get(position).msgTitle);
        tvd.time.setText(list.get(position).msgTwoTime);
        tvd.content.setText(list.get(position).msgContent);
